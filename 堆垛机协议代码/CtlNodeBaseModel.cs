...
namespace FlowCtlBaseModel
{
    ...
    public abstract class CtlNodeBaseModel : ILogRequired
    {
      ...
      //  protected ModPsRecordBll modPsRecordBll = new ModPsRecordBll();
        #endregion
        #region 属性
        public YHMesWrapper MesAcc { get; set; } //MES服务接口
        ...
        /// <returns></returns>
        protected List<MesDBAccess.Model.ProductOnlineModel> MESGetProductsInPallet(string palletID)
        {
            List<MesDBAccess.Model.ProductOnlineModel> products = new List<MesDBAccess.Model.ProductOnlineModel>();
            throw new NotImplementedException();
